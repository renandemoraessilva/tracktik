...
/**
 * Class responsible for the console
 */
class Console extends ElectronicItem implements ExtraItemsInterface
{
    /**
     * The amount of extra allowed
     */
    const AMOUNT_OF_EXTRAS = 4;
    ...
    {
        return $this->countExtras() < self::AMOUNT_OF_EXTRAS;
    }
